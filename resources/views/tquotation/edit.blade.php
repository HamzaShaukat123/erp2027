...
<script>
	...
	function addNewRow(){
		...
		if(latestValue!=""){
			...
			cell8.innerHTML ='<input type="number" class="form-control" id="pur2_qty'+index+'" value="0" step="any" disabled>' +
							 '<input type="hidden" class="form-control" name="pur2_qty[]" id="pur2_qty_show'+index+'" value="0">';
