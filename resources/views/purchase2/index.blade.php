                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="actions">
                                                        ...
                                                        <span class="separator"> | </span>
                                                        <a href="{{ route('edit-purchases2',$row->Sale_inv_no) }}" class=""><i class="fas fa-pencil-alt text-success"></i></a>
        ...
        $.ajax({
            ...
            success: function(result){
                $.each(result, function(k,v){
                    ...
                    html+= "<td class='text-center'><a class='mb-1 mt-1 me-1 text-primary' href='/purchase2/view/"+v['att_id']+"' target='_blank'><i class='fas fa-eye text-primary'></i></a></td>"
